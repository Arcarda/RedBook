...
- **Width:** Calculate based on page count and paper stock
  ...
  - For ~170 pages on 50lb cream paper: approximately **0.34"**
  - For ~170 pages on 60lb white paper: approximately **0.39"**
- **Content:** Title + Author name (readable when book is shelved)
- **Direction:** Text reads top-to-bottom (US standard)

### Full Cover Wrap (for print)

- **Total Width:** Back + Spine + Front + Bleeds
- **Example:** 5.25" + 0.4" (spine) + 5.25" = **10.9"** wide × 7.25" tall
- Request exact template from your printer (KDP, IngramSpark, etc.)
