...
| Page Height | 7 in |
| DPI | 300 |
| Pages | ~160-180 (Main) / ~200 (Journal) |
...
#### J-Master: Field Journal Spread (NEW)

1. **Morning Watch (Left Page):**
   - Header: "MORNING WATCH" (Small Caps)
   - Prompts: "1. Primary Objective", "2. Anticipated Friction", "3. The Protocol".
   - Response areas: 4-5 horizontal lines each (Style: `Journal-Entry-Line`).
2. **Evening Debrief (Right Page):**
   - Header: "EVENING DEBRIEF" (Small Caps)
   - Prompts: "1. The Win", "2. The Drift", "3. Final Score".
   - Response areas: 4-5 horizontal lines each.
